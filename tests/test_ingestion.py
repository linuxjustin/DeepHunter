...
class TestIngestionPipeline:
    def test_detect_source_type(self, sample_config) -> None:
        pipeline = IngestionPipeline(sample_config, KnowledgeStore())
    ...
    def test_detect_document_type(self, sample_config) -> None:
        pipeline = IngestionPipeline(sample_config, KnowledgeStore())
    ...
    def test_parse_single_markdown(self, sample_config, sample_markdown: str, tmp_path) -> None:
    ...
    def test_parse_single_file_not_found(self, sample_config) -> None:
        pipeline = IngestionPipeline(sample_config, KnowledgeStore())
        with pytest.raises(FileNotFoundError):
            pipeline.parse_single("/nonexistent/file.md")

    def test_parse_single_no_parser(self, sample_config, tmp_path) -> None:
    ...
    def test_run_empty_config(self, sample_config) -> None:
        store = KnowledgeStore()
        pipeline = IngestionPipeline(sample_config, store)
